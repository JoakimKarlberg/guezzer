...
export default {
    ...
    created () {
      ...
      Search({
            ...
            searchWord: YoutubeRandomizer.methods.GetSelectedCategory(), // This little cutie simulates searching 'cats' on youtube and picking first video - should be randomized
