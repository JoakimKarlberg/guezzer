...
export default {
    ...
    created () {
      ...
      Search({
            ...
            searchWord: YoutubeRandomizer.methods.GetRandomValue(YoutubeRandomizer.data.randomCategoryList), // This little cutie simulates searching 'cats' on youtube and picking first video - should be randomized
